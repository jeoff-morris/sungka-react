  ...
  return (
    <div className="privacy-policy">
      ...
      <p>
        ...
        Website, and MR JEOFF MORRIS, the owner and provider of this Website. MR
        JEOFF MORRIS takes the privacy of your information very seriously. This
        privacy policy applies to our use of any and all Data collected by us or
      ...
      <p>
        ...
        at: http://sungka.live/terms-and-conditions.{" "}
      </p>
      <b>
        Please read this privacy policy carefully. Definitions and
        interpretation
      </b>{" "}
      <ul>
      ...
      <table className="privacy-policy-table">
        <tr>
          <td>
            Data collectively all information that you submit to MR JEOFF
            MORRIS via the Website. This definition incorporates, where
        ...
        <tr>
          <td>
            Data Protection Laws any applicable law relating to the processing
        ...
        <tr>
          <td>GDPR the UK General Data Protection Regulation;</td>
        </tr>
        <tr>
          <td>
            MR JEOFF MORRIS,    we  or us MR JEOFF MORRIS of 12, Eyeletter
            House, Greenwood Road, Northamptonshire, NN5 5EG; 
          </td>
        </tr>
        <tr>
          <td>
        ...
        <tr>
          <td>
            ...
            either (i) employed by MR JEOFF MORRIS and acting in the course of
            their employment or (ii) engaged as a consultant or otherwise
            providing services to MR JEOFF MORRIS and accessing the Website in
            connection with the provision of such services; and{" "}
          </td>
        </tr>
        <tr>
          <td>
            Website the website that you are currently
            using, https://sungka.live, and any sub-domains of this site unless
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              ...
              entities, trusts and partnerships; d. "including" is understood to
              mean{" "}
            </li>
            <li>"including without limitation"; e. </li>
            <li>
      ...
      <ul>
        <li>
          This privacy policy applies only to the actions of MR JEOFF MORRIS and
          ...
          <li>
            {" "}
            For purposes of the applicable Data Protection Laws, MR JEOFF
            MORRIS is the "data controller". This means that MR JEOFF
            MORRIS determines the purposes for which, and the manner in which,
      ...
      <ul>
        <li>
          ...
          <ul>
            ...
            <li>your social network information agreed upon;</li>
          </ul>
        </li>{" "}
      ...
      <b>Data that is given to us by you</b>{" "}
      <ul>
        <li>
          MR JEOFF MORRIS will collect your Data in a number of ways, for
          example:
          <ul>
            <li>
            ...
            <li>
              when you elect to receive marketing communications from us; in
      ...
      <ul>
        ...
        <li>
          ...
          contacting us via this e-mail address: py.sungka@gmail.com.
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <ul>
            ...
            <li>
              <b>Right to restrict our use of your Data </b>Data - the right to
              "block" us from using your Data or limit the way in which we can
              use it.
            </li>
            <li>
              <b>Right to data portability </b>portability - the right to
        ...
        <li>
          ...
          e-mail address: py.sungka@gmail.com.
        </li>
        <li>
      ...
      <ul>
        <li>
          MR JEOFF MORRIS may, from time to time, expand or reduce our business
          and this may involve the sale and/or the transfer of control of all or
          part of MR JEOFF MORRIS. Data provided by Users will, where it is
          ...
          will, under the terms of this privacy policy, be permitted to use the
      ...
      <ul>
        <li>
          ...
          computer.   MR JEOFF MORRIS uses Cookies to improve your experience of
          using the Website and to improve our range of products.    MR JEOFF
          MORRIS has carefully chosen these Cookies and has taken steps to
        ...
        <li>
          ...
          enabling MR JEOFF MORRIS to provide a better experience and service to
        ...
        <li>
          ...
          internet browser. You can switch off  Cookies at any time, however,
          you may lose any information that enables you to access the Website
      ...
      <ul>
        <li>
          MR JEOFF MORRIS reserves the right to change this privacy policy as we
          ...
          the Website following the alterations.   You may contact MR JEOFF
          MORRIS by email at py.sungka@gmail.com.
        </li>
      </ul>
      <b>Cookies</b>
      <ul>
      ...
      <table className="privacy-policy-table">
        ...
        <tr>
          <td>Strictly necessary cookies</td>
          <td>Google Firebase: Cookie for collection of data about users</td>
        </tr>
        <tr>
          <td>Functionality cookies</td>
          <td>Mobile device cookie for collection of data about App Users</td>
        </tr>
      </table>
      <p>
        <b>
